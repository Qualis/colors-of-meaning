...
```python
from colors_of_meaning.domain.repository.coconut_repository import CoconutQueryRepository
...
from colors_of_meaning.application.use_case.coconut_use_case import GetCoconutUseCase
